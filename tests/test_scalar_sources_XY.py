...
class Test_Scalar_sources_XY:
    ...
    def test_spherical_wave_colimated(self):
        ...
        # carga de la onda esferica
        u.spherical_wave(A=1, r0=(0 * um, 0 * um), z0=-25.0 * mm, radius=1300 * um)

        t = Scalar_mask_XY(x0, y0, wavelength0)
        t.lens(r0=(0 * um, 0 * um), radius=(300 * um, 300 * um), focal=(25 * mm, 25 * mm), angle=0)
        u_salida = u * t
        u.draw(kind="field")
        t.draw(kind="field")
    ...
    def test_1laguerre(self):
        ...
        u.laguerre_beam(A=1, n=N, l=K, r0=(0 * um, 0 * um), w0=100 * um, z=0.01 * um, z0=0)
    ...
    def test_Hermite_Gauss(self):
        ...
        # u.hermite_gauss_beam(I0=1, w=100*um,
        #     n=[0,0,1,1,3], m=[0,1,0,1,3], c_mn=[1,1,1,1,1])
        u.hermite_gauss_beam(A=1, r0=(0 * um, 0 * um), w0=100 * um, n=1, m=1, z=0, z0=(0, 0))
    ...
    def test_extent_source(self):
        ...
        ix, _vx, _distx = nearest2(x, pos_x + 1)
        iy, _vy, _disty = nearest2(y, pos_y + 1)
        ...
        for x_i, y_i in zip(xpos, ypos, strict=False):
