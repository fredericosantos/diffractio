...
polarization_x = [1, 0]
polarization_y = [0, 1]
polarization_right = [1, 1.0j] / np.sqrt(2)
polarization_left = [1, -1.0j] / np.sqrt(2)
...
class Test_vector_sources_XY:
    ...
    def test_azimuthal_wave(self):
        ...
        EM = Vector_source_XY(x0, y0, wavelength)
        EM.azimuthal_wave(u=1, r0=(0 * um, 0 * um), radius=(length / 2, length / 2))
    ...
    def test_radial_wave(self):
        ...
        EM = Vector_source_XY(x0, y0, wavelength)
        EM.radial_wave(u=1, r0=(0 * um, 0 * um), radius=(length / 2, length / 2))
    ...
    def test_local_polarized_vector_wave(self):
        ...
        EM = Vector_source_XY(x0, y0, wavelength)
        EM.local_polarized_vector_wave(u=1, r0=(0 * um, 0 * um), m=1.5, fi0=0 * np.pi)
    ...
    def test_local_polarized_vector_wave_radial(self):
        ...
        EM = Vector_source_XY(x0, y0, wavelength)
        EM.local_polarized_vector_wave_radial(u=1, r0=(0 * um, 0 * um), m=0.5, fi0=np.pi / 2)
    ...
    def test_local_polarized_vector_wave_hybrid(self):
        ...
        EM = Vector_source_XY(x0, y0, wavelength)
        EM.local_polarized_vector_wave_hybrid(u=1, r0=(0 * um, 0 * um), m=1, n=3, fi0=np.pi / 2)
