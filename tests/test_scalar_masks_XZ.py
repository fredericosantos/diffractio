...
class Test_Scalar_masks_XZ:
    ...
    def test_add_masks(self):
        ...
        t1.cylinder(r0=(0, 100 * um), radius=(40 * um, 40 * um), refractive_index=2.5, angle=0)

        t1.cylinder(r0=(0, 100 * um), radius=(10 * um, 10 * um), refractive_index=1, angle=0)
    ...
    def test_rectangle(self):
        ...
        t1 = Scalar_mask_XZ(x=x0, z=z0, wavelength=wavelength)
        t1.square(
            r0=(0 * um, 100 * um), size=(150 * um, 50 * um), angle=0 * degrees, refractive_index=1.5
        )
        t1.draw_refractive_index()
    ...
    def test_semi_cylinder(self):
        ...
        t1 = Scalar_mask_XZ(x=x0, z=z0, wavelength=wavelength)
        t1.semi_cylinder(
            r0=(0 * um, 0 * um), radius=(100, 100), refractive_index=2, angle=0 * degrees
        )
    ...
    def test_probe(self):
        ...
        t1 = Scalar_mask_XZ(x=x0, z=z0, wavelength=wavelength)
        t1.probe(
            r0=(0, 50 * um), base=10 * um, length=200 * um, refractive_index=1.5, angle=0 * degrees
        )
